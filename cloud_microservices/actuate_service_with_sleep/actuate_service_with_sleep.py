...
consumer = KafkaConsumer(
    ...
    group_id="actuate_service_group"
)
...
def temperature_actuation(data):
    ...
    if sensor_type == "temperature":
        ...
        send_to_mosquitto(data, sensor_type, (timestamp > eight_pm) and bool(int(presence))) # If less than 20:00h, actuate
...
def send_to_mosquitto(data, device_type, actuation):
    ...
    print(f"Sending actuation command to {topic}: {actuation}", flush=True)
